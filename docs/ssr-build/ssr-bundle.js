...
/******/ 	__webpack_require__.p = "/preact-demo/";
/******/
...
var header_Header = function Header() {
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				match["Link"],
				{ activeClassName: header_style_default.a.active, href: 'github' },
				'Github'
			)
		)
	);
...
var github_Foo = function (_Component) {
	github__inherits(Foo, _Component);

	function Foo() {
		github__classCallCheck(this, Foo);

		return github__possibleConstructorReturn(this, _Component.apply(this, arguments));
	}

	Foo.prototype.loadData = function loadData() {
		var _this2 = this;

		fetch(SEARCH + '?q=preact').then(function (res) {
			return res.json();
		}).then(function (json) {
	...
	Foo.prototype.componentDidMount = function componentDidMount() {
		this.loadData();
	};

	Foo.prototype.render = function render(_ref, _ref2) {
		var _ref2$results = _ref2.results,
		    results = _ref2$results === undefined ? [] : _ref2$results;
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				results.map(function (result) {
					return Object(preact_min["h"])(github_Result, { result: result });
				})
			)
		);
	};
...
var github_Result = function Result(_ref4) {
	...
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				'a',
				{ href: result.html_url, target: '_blank', rel: 'noopener noreferrer' },
				result.full_name
			),
			'\uD83C\uDF1F',
			Object(preact_min["h"])(
...
var _ref5 = Object(preact_min["h"])(github_Foo, { path: '/github/' });
